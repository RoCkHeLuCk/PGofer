...
uses
  ...
  PGofer.Files.Controls
    in '..\..\Libraries\Lib\Files\PGofer.Files.Controls.pas',
  ...
  PGofer.Process.Controls
    in '..\..\Libraries\Lib\Process\PGofer.Process.Controls.pas',
  PGofer.Registry in '..\..\Libraries\Lib\Registry\PGofer.Registry.pas',
  PGofer.Registry.Controls
    in '..\..\Libraries\Lib\Registry\PGofer.Registry.Controls.pas',
  PGofer.Registry.Environment
    in '..\..\Libraries\Lib\Registry\PGofer.Registry.Environment.pas',
  PGofer.Services in '..\..\Libraries\Lib\Services\PGofer.Services.pas',
  PGofer.Services.Controls
    in '..\..\Libraries\Lib\Services\PGofer.Services.Controls.pas',
  PGofer.Services.Thread
    in '..\..\Libraries\Lib\Services\PGofer.Services.Thread.pas',
  PGofer.Sound in '..\..\Libraries\Lib\Sound\PGofer.Sound.pas',
  PGofer.Sound.Controls
    in '..\..\Libraries\Lib\Sound\PGofer.Sound.Controls.pas',
  PGofer.Sound.MMDevApi
    in '..\..\Libraries\Lib\Sound\PGofer.Sound.MMDevApi.pas',
  PGofer.System in '..\..\Libraries\Lib\System\PGofer.System.pas',
  PGofer.System.Controls
    in '..\..\Libraries\Lib\System\PGofer.System.Controls.pas',
  PGofer.System.Statements
    in '..\..\Libraries\Lib\System\PGofer.System.Statements.pas',
  ...
  PGofer.Triggers.HotKeys
    in '..\..\Libraries\Triggers\HotKeys\PGofer.Triggers.HotKeys.pas',
  ...
  PGofer.Triggers.HotKeys.Hook
    in '..\..\Libraries\Triggers\HotKeys\Input\PGofer.Triggers.HotKeys.Hook.pas',
  PGofer.Triggers.HotKeys.MMRawInput
    in '..\..\Libraries\Triggers\HotKeys\Input\PGofer.Triggers.HotKeys.MMRawInput.pas',
  PGofer.Triggers.HotKeys.RawInput
    in '..\..\Libraries\Triggers\HotKeys\Input\PGofer.Triggers.HotKeys.RawInput.pas',
  PGofer.Triggers.HotKeys.Async
    in '..\..\Libraries\Triggers\HotKeys\Input\PGofer.Triggers.HotKeys.Async.pas',
  ...
  PGofer.Triggers.Links.Thread
    in '..\..\Libraries\Triggers\Links\PGofer.Triggers.Links.Thread.pas',
  ...
  PGofer.Triggers.Tasks
    in '..\..\Libraries\Triggers\Tasks\PGofer.Triggers.Tasks.pas',
  PGofer.Component.Edit
    in '..\..\Libraries\Componet\Source\PGofer.Component.Edit.pas',
  PGofer.Component.ListView
    in '..\..\Libraries\Componet\Source\PGofer.Component.ListView.pas',
  PGofer.Component.RichEdit
    in '..\..\Libraries\Componet\Source\PGofer.Component.RichEdit.pas',
