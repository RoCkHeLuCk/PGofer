...
var
    CursorPoint : TPoint;
begin
    //pega a posi��o do cursor e posiciona a janela
...
begin
    inherited;
    //configura a janela para n�o aparecer na barra e n�o ativado.
...
begin
    ...
    begin
        ...
        begin
            ...
            FrmConfig.RgOp��es.ItemIndex := Item.Op��o;
        ...
        begin
            ...
            Item.Op��o := FrmConfig.RgOp��es.ItemIndex;
...
begin
    ...
    begin
        ...
        case (TItemMacro(TrvAutoKeys.Selected.Data).Op��o) of
               //digita o texto
           0 : begin
