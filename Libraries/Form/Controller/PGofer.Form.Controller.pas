...
type
   ...
   private
      ...
      SelectItem: TPGItem;
      procedure Notify( Sender: TPGItem; Action: TPGItemNotification );
   public
      { Public declarations }
   end;
...
begin
   NodeCreate( TGramatica.Global );
   TPGItem.OnItemNotify := Notify;
end;

procedure TFrmController.Notify( Sender: TPGItem; Action: TPGItemNotification );
var
   Node: TTreeNode;
begin
   case Action of
