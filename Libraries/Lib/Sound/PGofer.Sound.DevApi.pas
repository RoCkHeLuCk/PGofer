...
const
    ...
    IID_IAudioMeterInformation
      : TGUID = '{C02216F6-8C67-4B5B-9D00-D008E73E0064}';
...
type
    ...
    IAudioEndpointVolume = interface(IUnknown)
        ...
        function QueryHardwareSupport(out pdwHardwareSupportMask)
          : Integer; stdcall;
    ...
    IMMDeviceEnumerator = interface(IUnknown)
        ...
        function GetDevice(pwstrId: PWChar; out Dev: IMMDevice)
          : Hresult; stdcall;
