...
var
  ...
  hWinPosInfo: HDWP; // Handle da transa��o
begin
  ...
  // 4. Tenta iniciar a transa��o para 1 janela
  hWinPosInfo := BeginDeferWindowPos(1);
  if hWinPosInfo <> 0 then
  begin
    // 5. Tenta adicionar a janela � transa��o
    ...
    begin
      ...
      begin
        try
          BringWindowToTop(Self.Handle);
          SetForegroundWindow(Self.Handle);
          //// Refor�o do foco para o Windows 11
          ///SwitchToThisWindow(Self.Handle, True);
        finally
