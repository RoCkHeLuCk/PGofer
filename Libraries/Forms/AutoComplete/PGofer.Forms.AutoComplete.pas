        ...
        case Key of
            ...
            VK_RETURN:
                begin
                    ...
                    // seleciona |
                    c := Pos('|', FEditCtrl.Lines[FEditCtrl.CaretY - 1]);
                    if c > 0 then
                    begin
                        FEditCtrl.CaretX := c;
                        FEditCtrl.SelLength := 1;
                        FEditCtrl.SelText := '';
                        Self.FindCMD();
                    end; // if c > 0 then
...
begin
    case Key of
        ...
        VK_LEFT, VK_RIGHT:
            begin
                if Copy(FEditCtrl.Lines[FEditCtrl.CaretY - 1], FEditCtrl.CaretX,
                  1) = '|' then
                begin
                    FEditCtrl.SelLength := 1;
                    FEditCtrl.SelText := '';
...
begin
    ...
    begin
        ...
        // (Comando <> '') and
        if (not(Classe in [cmdUnDeclar .. cmdNumeric])) then
        begin
